...
public class TextArchitert
{
    ...
    public enum BuildMethood { instant, typewriter, fade }
    public BuildMethood buildMethood = BuildMethood.typewriter;
    ...
    public int charactersPerCycle { get { return speed <= 2f ? charactersMutiplier : speed <= 2.5f ? charactersMutiplier * 2 : charactersMutiplier * 3; } }
    private int charactersMutiplier = 1;

    public bool hurryUp = false;

    public TextArchitert(TextMeshProUGUI tmpro_ui)
    {
        this.tmpro_ui = tmpro_ui;
    }

    public TextArchitert(TextMeshPro tmpro_world)
    {
    ...
    IEnumerator Building()
    {
        ...
        switch (buildMethood)
        {
            case BuildMethood.typewriter:
                yield return Build_Typewriter();
                break;
            case BuildMethood.fade:
